...
async def update_goal(request: web.Request) -> web.Response:
    ...
    try:
        ...
        updated_goal = Goal(
            ...
            start_time=_parse_datetime(data.get("start_time")) if data.get("start_time") else existing.start_time,
            end_time=_parse_datetime(data.get("end_time")) if data.get("end_time") else existing.end_time,
