(function () {
    ...
    function renderQuadrantView(container, events) {
        ...
        const api = core();
        const escapeHtml = api.escapeHtml || function(t){return t||'';};
        const showEventDetail = window.ScheduleAppEventModal?.showEventDetail;
    ...
    async function renderTodoView() {
        ...
        const completeEvent = api.completeEvent;
        const uncompleteEvent = api.uncompleteEvent;
        const deleteEvent = api.deleteEvent;
        const getCategoryColor = api.getCategoryColor;
        const formatTime = api.formatTime;
        const formatDate = api.formatDate;
        const isSameDay = api.isSameDay;
        const showConfirm = api.showConfirm;
        const openEventModal = window.ScheduleAppEventModal?.openEventModal;
        const renderSelectionBar = window.ScheduleAppSelection?.renderSelectionBar;
        const toggleSelection = window.ScheduleAppSelection?.toggleSelection;
        const enterSelectionMode = window.ScheduleAppSelection?.enterSelectionMode;
        const getSelectionSet = window.ScheduleAppSelection?.getSelectionSet;
